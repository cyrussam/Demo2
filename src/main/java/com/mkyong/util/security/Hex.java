//package org.ibase4j.mazex.security;
package com.mkyoung.util.security;
...
public class Hex {
	 ...
	 */
	public static final String DEFAULT_CHARSET_NAME = "UTF-32";
	...
	public static void main(String[] args) {
		System.out.println(encodeHexString("尊敬的15989507323你好，你充值的CCC 100已到账".getBytes()));
	}
