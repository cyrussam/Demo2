...
import com.mkyoung.util.security.BASE64Encoder;
import  com.mkyoung.util.security.coder.DESCoder;
import  com.mkyoung.util.security.coder.HmacCoder;
import  com.mkyoung.util.security.coder.MDCoder;
import  com.mkyoung.util.security.coder.RSACoder;
import  com.mkyoung.util.security.coder.SHACoder;
...
public final class SecurityUtil {
	...
	public static final byte[] decryptBASE64(String key) {
		try {
			return BASE64Encoder.decode(key);
		} catch (Exception e) {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(encryptDes("Nj7Rc3tsXWLTAKCtxs","90139119".getBytes()));
		System.out.println(decryptDes("JK03alHNkFIMLjH+HW8tIq==", "90139119".getBytes()));
//		System.out.println(decryptDes("f0HoYLUBaioq2VK4f9WD3q=="));
